...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH 630   // Unload filament length from hotend in mm
  ...
  #define FILAMENT_CHANGE_LOAD_LENGTH 570     // Load filament length over hotend in mm
